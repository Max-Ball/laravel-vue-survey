<template>
  <div class="flex items-center justify-between">
    ...
    <div class="flex items-center">
      ...
      <button class="flex items-center text-xs py-1 px-3 mr-2 rounded-sm text-white bg-gray-600 hover:bg-gray-700"
    ...
    <div v-if="shouldHaveOptions()" class="mt-2">
      ...
      <div v-for="(option, index) in model.data.options" :key="option.uuid" class="flex items-center mb-1">
        ...
        <button type="button" @click="removeOption(option)"
          ...
          <svg class="h-3 w-3 text-red-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
